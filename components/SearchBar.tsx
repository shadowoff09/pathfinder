  ...
  return (
    <div className="relative w-full max-w-md mx-auto ">
      <Input
        ...
        className="dark:text-white text-black font-onest font-semibold pl-10 pr-4 py-2 w-full bg-background/50 dark:bg-background/60 backdrop-blur-sm shadow-sm border-input hover:border-accent-foreground/20 focus:border-accent-foreground/10 focus:ring-accent-foreground/50 dark:border-input/80 dark:hover:border-accent-foreground/30 dark:focus:border-accent-foreground/60 dark:focus:ring-accent-foreground/60 rounded-lg"
        value={searchTerm}
