...
export default function CoordinatesDisplay({ longitude, latitude, zoom }: CoordinatesDisplayProps) {
  return (
    <div className="absolute hidden md:block md:top-[70px] right-2 font-onest">
      <div className="bg-background/40 dark:bg-background/60 backdrop-blur-sm p-3 rounded-lg shadow-lg border border-border/50 transition-all duration-300 ease-in-out">
